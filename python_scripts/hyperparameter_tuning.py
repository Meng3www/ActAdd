...
def ht_steer_all_layers(prompt_add, prompt_sub, model, prompts, max_coeff, seed, sampling_kwargs, output_file_name):
...
def steer_de():
    ...
    prompts = load_data("val_gemini_de.json", num_samples)
    base_generate(model, prompts, sampling_kwargs, "gemini_base_de")
    
    prompt_add, prompt_sub = "Love", "Hate"
    ht_steer_all_layers_batch(prompt_add, prompt_sub, model, prompts, max_coeff, seed, sampling_kwargs, "gemini_Love_de")
    prompt_add, prompt_sub = "Hate", "Love"
    ht_steer_all_layers_batch(prompt_add, prompt_sub, model, prompts, max_coeff, seed, sampling_kwargs, "gemini_Hate_de")

    prompt_add, prompt_sub = " love", " hate"
    ht_steer_all_layers_batch(prompt_add, prompt_sub, model, prompts, max_coeff, seed, sampling_kwargs, "gemini__love_de")
    prompt_add, prompt_sub = " hate", " love"
    ht_steer_all_layers_batch(prompt_add, prompt_sub, model, prompts, max_coeff, seed, sampling_kwargs, "gemini__hate_de")
